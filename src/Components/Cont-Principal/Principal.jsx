...
export const Principal = () => {
    ...
    useGSAP(() => {
        ...
        // 1. El título y la imagen bajan con un ligero rebote
        tl.from("#perfil-foto", {
            scale: 0,
            opacity: 0,
            duration: 0.8,
            ...
            .from("#titulo-principal", {
                x: -30,
                opacity: 0,
                duration: 0.8,
                ease: "power2.out"
            }, "-=0.4") // Empieza un poco antes de que termine la foto
                ...
                <div className="relative z-1 w-full max-w-4xl bg-white rounded-2xl border-2 border-gray-400 shadow-xl overflow-hidden">
                    ...
                    <div className="p-12 text-center flex flex-col items-center">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-4">
                            ...
                            <div id="perfil-foto" className="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-orange-500 overflow-hidden shadow-sm order-last md:order-first">
                                <img
                                    src={perfilIcon}
                                    alt="Sofia"
                            ...
                            <h1 id="titulo-principal" className="text-5xl md:text-7xl font-light text-gray-700 mb-4">
